import { EthereumNetworkID, } from '../models/ethereum-models.js';
export const ethereumArbitrumSepolia = {
    name: 'ArbSepolia',
    displayName: 'Arbitrum Sepolia',
    id: EthereumNetworkID.ArbitrumSepolia,
    defaultNodeURL: 'https://sepolia-rollup.arbitrum.io/rpc',
};
export const ethereumArbitrum = {
    name: 'Arbitrum',
...
export const dlcContractNames = ['DLCManager', 'DLCBTC'];
